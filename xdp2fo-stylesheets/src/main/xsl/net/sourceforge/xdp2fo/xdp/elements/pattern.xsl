...
<!--
 | $Id: pattern.xsl,v 1.3 2008/06/25 16:13:43 rlangbehn Exp $
 |
 ...
 |
 | Version: $Revision: 1.3 $ $Date: 2008/06/25 16:13:43 $
...
<xsl:stylesheet
	...
	<!-- pattern element                                                   -->
	<!-- ================================================================= -->
	<xsl:template match="xft:pattern">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
	
	<xsl:template match="xft:pattern" mode="svg">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
