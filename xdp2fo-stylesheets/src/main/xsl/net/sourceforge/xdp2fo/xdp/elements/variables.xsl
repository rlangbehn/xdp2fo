...
<!--
 | $Id: variables.xsl,v 1.2 2008/06/23 15:32:06 rlangbehn Exp $
 |
 ...
 |
 | Version: $Revision: 1.2 $ $Date: 2008/06/23 15:32:06 $
...
<xsl:stylesheet
	...
	<!-- variables element                                                 -->
	<!-- ================================================================= -->
	<xsl:template match="xft:proto/xft:variables">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
																
	<xsl:template match="xft:subform/xft:variables">
		<xsl:call-template name="log:trace"/>
