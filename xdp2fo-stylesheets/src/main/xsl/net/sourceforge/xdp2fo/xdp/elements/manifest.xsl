...
<!--
 | $Id: manifest.xsl,v 1.2 2008/06/23 15:32:11 rlangbehn Exp $
 |
 ...
 |
 | Version: $Revision: 1.2 $ $Date: 2008/06/23 15:32:11 $
...
<xsl:stylesheet
	...
	<!-- manifest element                                                  -->
	<!-- ================================================================= -->
	<xsl:template match="xft:manifest">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
	
	<xsl:template match="xft:variables/xft:manifest">
		<xsl:call-template name="log:trace"/>
