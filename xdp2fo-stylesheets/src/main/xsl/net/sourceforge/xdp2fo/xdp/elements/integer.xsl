...
<!--
 | $Id: integer.xsl,v 1.2 2008/06/23 15:32:12 rlangbehn Exp $
 |
 ...
 |
 | Version: $Revision: 1.2 $ $Date: 2008/06/23 15:32:12 $
...
<xsl:stylesheet
	...
	<!-- integer element                                                   -->
	<!-- ================================================================= -->
	<xsl:template match="xft:integer">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
	
	<xsl:template match="xft:variables/xft:integer">
		<xsl:call-template name="log:trace"/>
