...
<!--
 | $Id: connectionset.xsl,v 1.2 2008/06/23 15:31:17 rlangbehn Exp $
 |
...
<xsl:stylesheet
	...
	xmlns:xfcs="http://www.xfa.org/schema/xfa-connection-set/2.4/"
	xmlns:log="http://xdp2fo.sourceforge.net/logging"
	exclude-result-prefixes="xfcs"
	version="1.0">

    <!-- ================================================================= -->
    <!-- connectionSet element                                             -->
    <!-- ================================================================= -->
    <xsl:template match="xfcs:connectionSet">
