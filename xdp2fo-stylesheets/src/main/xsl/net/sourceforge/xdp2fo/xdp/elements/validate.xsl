...
<!--
 | $Id: validate.xsl,v 1.3 2008/06/23 15:32:06 rlangbehn Exp $
 |
 ...
 |
 | Version: $Revision: 1.3 $ $Date: 2008/06/23 15:32:06 $
...
<xsl:stylesheet
	...
	<!-- validate element                                                  -->
	<!-- ================================================================= -->
	<xsl:template match="xft:validate">
	...
	<!-- validate properties                                               -->
	<!-- ================================================================= -->
	<xsl:template match="xft:validate/@formatTest">
	</xsl:template>
	
	<xsl:template match="xft:validate/@nullTest">
	</xsl:template>
	
	<xsl:template match="xft:validate/@scriptTest">
	</xsl:template>
