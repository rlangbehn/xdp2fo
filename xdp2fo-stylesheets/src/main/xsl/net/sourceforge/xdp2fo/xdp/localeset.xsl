...
<!--
 | $Id: localeset.xsl,v 1.2 2008/06/23 15:31:17 rlangbehn Exp $
 |
...
<xsl:stylesheet
	...
	xmlns:xfls="http://www.xfa.org/schema/xfa-locale-set/2.1/"
	xmlns:log="http://xdp2fo.sourceforge.net/logging"
	exclude-result-prefixes="xfls"
	version="1.0">

    <!-- ================================================================= -->
    <!-- localeSet element                                                 -->
    <!-- ================================================================= -->
    <xsl:template match="xfls:localeSet">
