...
<!--
 | $Id: exData.xsl,v 1.4 2008/07/07 21:58:40 rlangbehn Exp $
 |
 ...
 |
 | Version: $Revision: 1.4 $ $Date: 2008/07/07 21:58:40 $
...
<xsl:stylesheet
	...
	<!--                                                                   -->
	<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
	<xsl:template match="xft:variables/xft:exData">
		<xsl:call-template name="log:trace"/>
	...
	<!-- exData properties                                                 -->
	<!-- ================================================================= -->
	<xsl:template match="xft:exData/@contentType">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
	
	<xsl:template match="xft:exData/@href">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
	
	<xsl:template match="xft:exData/@maxLength">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
	
	<xsl:template match="xft:exData/@rid">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
	
	<xsl:template match="xft:exData/@transferEncoding">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
