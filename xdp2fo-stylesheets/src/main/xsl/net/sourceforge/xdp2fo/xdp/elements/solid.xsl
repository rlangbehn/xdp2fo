...
<!--
 | $Id: solid.xsl,v 1.3 2008/06/25 16:13:44 rlangbehn Exp $
 |
 ...
 |
 | Version: $Revision: 1.3 $ $Date: 2008/06/25 16:13:44 $
...
<xsl:stylesheet
	...
	<!-- solid element                                                     -->
	<!-- ================================================================= -->
	<xsl:template match="xft:solid">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
	
	<xsl:template match="xft:solid" mode="svg">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
