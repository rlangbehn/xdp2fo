...
<!--
 | $Id: boolean.xsl,v 1.2 2008/06/23 15:32:07 rlangbehn Exp $
 |
 ...
 |
 | Version: $Revision: 1.2 $ $Date: 2008/06/23 15:32:07 $
...
<xsl:stylesheet
	...
	<!-- boolean element                                                   -->
	<!-- ================================================================= -->
	<xsl:template match="xft:boolean">
		<xsl:call-template name="log:trace"/>
	</xsl:template>
	
	<xsl:template match="xft:variables/xft:boolean">
		<xsl:call-template name="log:trace"/>
		<xsl:element name="xsl:variable">
			...
			<xsl:attribute name="select">
				<xsl:value-of select="concat('boolean(', . ,')')"/>
			</xsl:attribute>
		</xsl:element>
	</xsl:template>
